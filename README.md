...
This document provides an extension to the RFC8520 Manufacturer Usage
Description (MUD).  It details how a base MUD file can authorize additonal
URLs for updates.
...
sending an e-mail to [our mailing list](https://www.ietf.org/mailman/listinfo/opsawg).
